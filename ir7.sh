...
# =================================================================
#      Advanced IPv6 Tunnel Manager (HUB & CLIENT) v4.2
#      Features: Colorful UI table, ID Selection, Persistence
# =================================================================
...
#!/bin/bash
# Auto-generated by Tunnel Manager v4.2 (HUB Mode - 7 Servers)
...
function apply_client() {
    ...
    cat <<EOF > /etc/rc.local
#!/bin/bash
# Auto-generated by Tunnel Manager v4.2 (CLIENT Mode)
...
# --- Edit HUB Wizard (New Colorful Table) ---
...
while true; do
    clear
    echo -e "${C_CYAN}==============================================${C_RESET}"
    echo -e "${C_CYAN}    Advanced Tunnel Manager v4.2 (Colorful)   ${C_RESET}"
    echo -e "${C_CYAN}==============================================${C_RESET}"
    echo ""
