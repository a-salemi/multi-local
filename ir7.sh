...
# =================================================================
#      Advanced IPv6 Tunnel Manager (HUB & CLIENT) v4.0
#      Supports 7 Servers + Persistence + Editing
# =================================================================
...
# --- Global Constants (Updated for 7 Servers) ---
declare -a IPV6_SUBNETS=(
    ...
    "fd76:2917:72d9" 
    "fdce:8ee9:a813"
    "fd79:bf37:1d4d"  # New Server 6
    "fd9b:cd62:8f26"  # New Server 7
)
...
#!/bin/bash
# Auto-generated by Tunnel Manager v4.0 (HUB Mode - 7 Servers)
...
function apply_client() {
    ...
    cat <<EOF > /etc/rc.local
#!/bin/bash
# Auto-generated by Tunnel Manager v4.0 (CLIENT Mode)
...
function setup_hub_wizard() {
    clear
    echo -e "${C_CYAN}=== HUB Server (Kharej) Initial Setup (7 Servers) ===${C_RESET}\n"
...
while true; do
    ...
    echo -e "${C_CYAN}    Advanced Tunnel Manager v4.0 (7 Servers)  ${C_RESET}"
    echo -e "${C_CYAN}==============================================${C_RESET}"
    echo ""
